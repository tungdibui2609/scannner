...
// LOGS & TASKS
export const AUDIT_LOG_SHEET_RANGE = "logs!A2:G"; // A=TS, B=User, C=Action, D=Path, E=Details
...
export const USER_SHEET_RANGE = "Users!A1:Z";     // Read whole user table including header
export const PERMISSIONS_SHEET_RANGE = "Permissions!A2:D"; // Role-based permissions
